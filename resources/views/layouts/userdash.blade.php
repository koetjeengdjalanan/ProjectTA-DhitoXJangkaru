                    ...
                    <div style="width: 300px">
                        <div class="notification-messages info">
                            <div class="user-profile">
                                <img src={{ url('assets/img/profiles/d.jpg') }} alt=""
                                    data-src={{ url('assets/img/profiles/d.jpg') }}
                                    data-src-retina={{ url('assets/img/profiles/d2x.jpg') }} width="35"
                                    height="35" />
                            </div>
                ...
                <div class="pull-right">
                    <div class="chat-toggler sm">
                        <div class="profile-pic">
                            <img src={{ url('assets/img/profiles/avatar_small.jpg') }} alt=""
                                data-src={{ url('assets/img/profiles/avatar_small.jpg') }}
                                data-src-retina={{ url('assets/img/profiles/avatar_small2x.jpg') }} width="35"
                                height="35" />
                ...
                <div class="user-info-wrapper sm">
                    <div class="profile-wrapper sm">
                        <img src={{ url('assets/img/profiles/avatar.jpg') }} alt=""
                            ...
                            data-src-retina={{ url('assets/img/profiles/avatar2x.jpg') }} width="69" height="69" />
                        <div class="availability-bubble online"></div>
                    </div>
                    ...
                    <div class="side-widget">
                        ...
                        <div class="side-widget-content">
                            ...
                            <div class="user-details-wrapper active" data-chat-status="online"
                                data-chat-user-pic={{ url('assets/img/profiles/d.jpg') }}
                                data-chat-user-pic-retina={{ url('assets/img/profiles/d2x.jpg') }}
